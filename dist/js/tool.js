...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modals_UpdateResourceModal__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modals_UpdateResourceModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__modals_UpdateResourceModal__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: { UpdateResourceModal: __WEBPACK_IMPORTED_MODULE_0__modals_UpdateResourceModal___default.a },
  ...
  methods: {
    ...
    confirmUpdateModal: function confirmUpdateModal() {
      this.updateModalOpen = false;
      this.$router.go();
    }
  },
...
Component.options.__file = "resources/js/modals/UpdateResourceModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-64d0632b", Component.options)
  } else {
    hotAPI.reload("data-v-64d0632b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        submitViaUpdateResource: function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(e) {
        ...
        updateResource: function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee5() {
                var _ref8, redirect;
                        ...
                        switch (_context5.prev = _context5.next) {
                            ...
                            case 15:
                                ...
                                if (_context5.t0.response.status == 422) {
                                    this.validationErrors = new __WEBPACK_IMPORTED_MODULE_1_laravel_nova__["Errors"](_context5.t0.response.data.errors);
    ...
    [
      _c(
        ...
        [
          _c(
            "card",
            { staticClass: "overflow-hidden  max-w-modal min-w-modal" },
            [
              _vm.panels
                ? _c(
                    "form",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-64d0632b", module.exports)
  }
}
        ...
        _c(
          ...
          [
                    ...
                    _vm.relationshipType == "morphToMany"
                            ...
                            directives: [
                              {
                                name: "tooltip",
                                rawName: "v-tooltip.click",
                                value: _vm.__("Edit Attached"),
                                expression: "__('Edit Attached')",
                                modifiers: { click: true }
                              }
                            ],
                            staticClass:
                      ...
                      : _c(
                          "span",
                          {
                            ...
                            staticClass:
                              "cursor-pointer text-info text-70 hover:text-primary mr-3",
                            on: {
            ...
            !_vm.viaManyToMany
                    ...
                    directives: [
                      {
                        name: "tooltip",
                        rawName: "v-tooltip.click",
                        value: _vm.__(_vm.viaManyToMany ? "Detach" : "Delete"),
                        expression: "__(viaManyToMany ? 'Detach' : 'Delete')",
                        modifiers: { click: true }
                      }
                    ],
                    staticClass:
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.deleteModalOpen || _vm.restoreModalOpen || _vm.updateModalOpen
              ? _c(
                  "portal",
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _vm.updateModalOpen
                      ? _c("update-resource-modal", {
                          attrs: {
                            resourceId: _vm.resource.id.value,
                            resourceName: _vm.resourceName
                          },
                          on: {
                            close: _vm.closeUpdateModal,
                            confirm: _vm.confirmUpdateModal
                          }
                        })
                      : _vm._e()
                  ],
